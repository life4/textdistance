...
class Hamming(_Base):
    ...
    def __init__(self, qval=1, test_func=None, truncate: bool = False, external: bool = True) -> None:
        self.qval = qval
...
class JaroWinkler(_BaseSimilarity):
    ...
    def __init__(self, long_tolerance: bool = False, winklerize: bool = True, qval=1, external: bool = True) -> None:
        self.qval = qval
...
class Jaro(JaroWinkler):
    def __init__(self, long_tolerance: bool = False, qval=1, external: bool = True) -> None:
        super().__init__(
