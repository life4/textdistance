...
libraries.register('DamerauLevenshtein', TextLibrary('abydos.distance', 'damerau_levenshtein'))
libraries.register('DamerauLevenshtein', TextLibrary('jellyfish', 'damerau_levenshtein_distance'))
libraries.register('DamerauLevenshtein', TextLibrary('pyxdameraulevenshtein', 'damerau_levenshtein_distance'))
libraries.register('Hamming', TextLibrary('abydos.distance', 'hamming'))
...
libraries.register('JaroWinkler', TextLibrary('py_stringmatching.similarity_measure.jaro_winkler', 'jaro_winkler'))
libraries.register('Levenshtein', TextLibrary('abydos.distance', 'levenshtein'))
